      ...
      <div className="hidden md:block px-6 py-6 bg-gray-900">
        <div className="flex justify-center items-center">
          <div className="px-4 flex justify-center items-center gap-4">
            ...
            <div className="font-[Poppins] text-sm text-slate-600">Made with <a className='text-[#f7407d]'>❤</a> by <a href='#' className='text-[#f7407d] cursor-pointer hover:text-[#7CFC00]'>Arpan, </a> <a href='#' className='text-[#f7407d] cursor-pointer hover:text-[#7CFC00]'>Mriganka, </a> <a href='#' className='text-[#f7407d] cursor-pointer hover:text-[#7CFC00]'>Supratim</a> <br/> 
